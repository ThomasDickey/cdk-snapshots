...
int main (int argc, char **argv)
{
   ...
   while (1)
   {
      ...
      if ((ret = getopt (argc, argv, "F:f:l:h:s:i:a:T:L:B:O:X:Y:NS")) == -1)
      {
         break;
      }
   ...
   if (widget == 0)
   {
      ...
      fprintf (stderr, "Error: Could not create the numeric slider field. Is the window too small?\n");
