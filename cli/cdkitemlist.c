/* $Id: cdkitemlist.c,v 1.4 2001/04/20 22:51:11 tom Exp $ */
 ...
 */
char *FPUsage = "-l List | -f filename [-d Default Item] [-T Title] [-L Label] [-B Buttons] [-O Output File] [-X X Position] [-Y Y Position] [-N] [-S]";
...
int main (int argc, char **argv)
{
   ...
   while (1)
   {
      ...
      if ((ret = getopt (argc, argv, "l:f:d:T:L:B:O:X:Y:NS")) == -1)
      {
         break;
      }
